(function () {
    ...
    function Orbit(
        object, // TODO: fov property only be used in pan()
        {
    ...
    class TextureLoader {
        static load(
            ...
            const cacheID =
                ...
                unpackAlignment +
                flipY +
                gl.renderer.id; // Check cache for existing texture
        ...
        static getSupportedExtensions(gl) {
            ...
            const extensions = {
                pvrtc:
                    gl.renderer.getExtension('WEBGL_compressed_texture_pvrtc') || gl.renderer.getExtension('WEBKIT_WEBGL_compressed_texture_pvrtc'),
                s3tc:
