...

{
    ...
    function update() {
        ...
        postBloom.render({ texture: postComposite.uniform.value }); // targetOnly 没有作用？

        // Re-enable composite pass
        compositePass.enabled = true;
        // Now reset so post can render to canvas upon its last pass
        postComposite.targetOnly = false;

        // This renders to canvas - pass back in its previous render of the scene
