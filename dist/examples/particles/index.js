import {R as Renderer, a as Camera, G as Geometry, P as Program, M as Mesh} from "../../chunks/GLTFSkin.e3c4699d.js";
const vertex = `
...
function update(t) {
  requestAnimationFrame(update);
  particles.rotation.x = Math.sin(t * 2e-4) * 0.1;
  particles.rotation.y = Math.cos(t * 5e-4) * 0.15;
