import {R as Renderer, a as Camera, T as Transform, b as Texture, P as Program, G as Geometry, M as Mesh} from "../../chunks/GLTFSkin.e3c4699d.js";
const vertex = `
...
function update() {
  requestAnimationFrame(update);
  if (lineLoopMesh)
    lineLoopMesh.rotation.y -= 5e-3;
  if (wireframeMesh)
    wireframeMesh.rotation.y += 5e-3;
