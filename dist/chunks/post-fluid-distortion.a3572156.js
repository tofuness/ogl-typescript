import {R as Renderer, a as Camera, h as Vec2, G as Geometry, M as Mesh, P as Program, C as Color} from "./GLTFSkin.e3c4699d.js";
import {R as RenderTarget} from "./RenderTarget.e49cf8bd.js";
import {B as Box} from "./Box.d06f990d.js";
import {P as Post} from "./Post.2b621454.js";
import {N as NormalProgram} from "./NormalProgram.5be142d7.js";
import "./Plane.7e1c7186.js";
import "./Triangle.f7efba91.js";
const fragment = `
...
function splat({x, y, dx, dy}) {
  ...
  splatProgram.program.uniforms.radius.value = radius / 100;
  gl.renderer.render({
    scene: splatProgram,
...
function update(t) {
  ...
  mesh.rotation.y -= 25e-4;
  mesh.rotation.x -= 5e-3;
  pass.uniforms.uTime.value = t * 1e-3;
